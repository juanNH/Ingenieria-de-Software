    ...
    public class IdiomasView_380_jh : LocalizedUserControl_380_jh
    {
        ...
        private TreeNode CrearNodoCatalogoEtiquetas_380_jh()
        {
            ...
            AgregarSeccionCatalogo_380_jh(catalogo, "Menu", new[]
            {
                ...
                new UiCatalogItem_380_jh("MENU_CHANGE_AUDIT", "Menu auditoria de cambios"),
                ...
                new UiCatalogItem_380_jh("MENU_BLOOD_BANK", "Menu banco de sangre"),
                new UiCatalogItem_380_jh("MENU_DONORS", "Menu donantes"),
                new UiCatalogItem_380_jh("MENU_DONATIONS", "Menu donaciones"),
                new UiCatalogItem_380_jh("MENU_UNITS", "Menu unidades"),
            ...
            AgregarSeccionCatalogo_380_jh(catalogo, "Bitacora", new[]
            {
                ...
                new UiCatalogItem_380_jh("BITACORA_MODULE_BLOOD_BANK", "Modulo banco de sangre"),
                ...
                new UiCatalogItem_380_jh("BITACORA_ACTION_DONOR_REGISTERED", "Accion donante registrado"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_DONATION_REGISTERED", "Accion donacion registrada"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_UNITS_GENERATED", "Accion unidades generadas"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_UNIT_CLASSIFIED", "Accion unidad clasificada"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_UNIT_RELEASED", "Accion unidad liberada"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_UNIT_BLOCKED", "Accion unidad bloqueada"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_UNIT_DISCARDED", "Accion unidad descartada"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_OPERATION_FAILURE", "Accion operacion fallida"),
            ...
            AgregarSeccionCatalogo_380_jh(catalogo, "Banco de sangre", new[]
            {
                new UiCatalogItem_380_jh("MENU_INTEGRITY", "Integridad"),
                new UiCatalogItem_380_jh("BITACORA_MODULE_INTEGRITY", "Módulo integridad"),
                new UiCatalogItem_380_jh("INTEGRITY_OK", "Integridad: última verificación correcta."),
                new UiCatalogItem_380_jh("INTEGRITY_BLOCKED", "Modo solo consulta: integridad comprometida."),
                new UiCatalogItem_380_jh("INTEGRITY_UNAVAILABLE", "No se pudo verificar la integridad."),
                new UiCatalogItem_380_jh("INTEGRITY_PENDING", "Pendiente: revisar los datos y aceptar la base inicial."),
                new UiCatalogItem_380_jh("INTEGRITY_DESCRIPTION", "Verificación de filas, tablas e historiales protegidos."),
                new UiCatalogItem_380_jh("INTEGRITY_VERIFY", "Verificar / actualizar"),
                new UiCatalogItem_380_jh("INTEGRITY_INITIALIZE", "Aceptar base inicial"),
                new UiCatalogItem_380_jh("INTEGRITY_RESTORE", "Restaurar desde historial"),
                new UiCatalogItem_380_jh("INTEGRITY_ENTITY", "Entidad"),
                new UiCatalogItem_380_jh("INTEGRITY_ID", "ID"),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE", "Incidencia"),
                new UiCatalogItem_380_jh("INTEGRITY_DATE", "Detectada"),
                new UiCatalogItem_380_jh("INTEGRITY_CURRENT", "Registro actual (JSON; vacío si falta)"),
                new UiCatalogItem_380_jh("INTEGRITY_TRUSTED", "Última versión del historial (usar solo si es íntegro)"),
                new UiCatalogItem_380_jh("INTEGRITY_CONFIRM_BASELINE", "¿Aceptás los datos actuales como base inicial? Confirmá solo después de revisarlos y respaldarlos. Esta acción no corrige datos previos y se realiza una sola vez."),
                new UiCatalogItem_380_jh("INTEGRITY_CONFIRM_RESTORE", "¿Restaurar todas las inconsistencias recuperables desde las últimas versiones verificadas? Se conservarán los identificadores y se auditará la operación. No se aceptarán datos alterados como válidos."),
                new UiCatalogItem_380_jh("INTEGRITY_RECOVERED", "Operación completada e integridad verificada."),
                new UiCatalogItem_380_jh("INTEGRITY_RECOVERY_FAILED", "No se confirmó la recuperación. Verificá nuevamente el estado y revisá la bitácora antes de reintentar."),
                new UiCatalogItem_380_jh("INTEGRITY_STALE_PREVIEW", "Los datos cambiaron desde la revisión. Actualizá el informe antes de confirmar."),
                new UiCatalogItem_380_jh("INTEGRITY_BACKUP_REQUIRED", "La fuente no permite una recuperación segura; se requiere un backup confiable."),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE_SIN_INICIALIZAR", "Base inicial ausente o incompleta"),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE_DVH", "Dígito de fila incorrecto"),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE_DVV", "Dígito de tabla incorrecto"),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE_HISTORIAL_INVALIDO", "Historial alterado"),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE_FALTANTE", "Registro eliminado"),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE_SIN_VERSION", "Registro sin versión confiable"),
                new UiCatalogItem_380_jh("INTEGRITY_TYPE_VERSION_DIFERENTE", "Datos distintos del historial"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_INTEGRITY_DETECTED", "Error de integridad detectado"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_INTEGRITY_INITIALIZED", "Base inicial de integridad aceptada"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_INTEGRITY_RESTORED", "Integridad restaurada"),
                new UiCatalogItem_380_jh("BITACORA_ACTION_RESTORE_FAILED", "Recuperación fallida"),
            });

            AgregarSeccionCatalogo_380_jh(catalogo, "Banco de sangre - operaciones", new[]
            {
                new UiCatalogItem_380_jh("DONORS_TITLE", "Titulo de donantes"),
                new UiCatalogItem_380_jh("DONORS_DESCRIPTION", "Descripcion de donantes"),
                new UiCatalogItem_380_jh("DONORS_DETAIL", "Detalle de donante"),
                new UiCatalogItem_380_jh("DONOR_DOCUMENT", "Documento de donante"),
                new UiCatalogItem_380_jh("DONOR_NAME", "Nombre de donante"),
                new UiCatalogItem_380_jh("DONOR_LASTNAME", "Apellido de donante"),
                new UiCatalogItem_380_jh("DONOR_BIRTHDATE", "Fecha de nacimiento"),
                new UiCatalogItem_380_jh("DONOR_PHONE", "Telefono de donante"),
                new UiCatalogItem_380_jh("DONOR_EMAIL", "Email de donante"),
                new UiCatalogItem_380_jh("DONOR_ADDRESS", "Domicilio de donante"),
                new UiCatalogItem_380_jh("DONOR_STATUS", "Estado de donante"),
                new UiCatalogItem_380_jh("DONOR_REGISTERED", "Donante registrado"),
                new UiCatalogItem_380_jh("DONOR_DUPLICATE", "Donante duplicado"),
                new UiCatalogItem_380_jh("DONOR_INVALID", "Datos invalidos de donante"),
                new UiCatalogItem_380_jh("DONOR_ERROR", "Error de donante"),
                new UiCatalogItem_380_jh("DONATION_TITLE", "Titulo de donaciones"),
                new UiCatalogItem_380_jh("DONATION_DESCRIPTION", "Descripcion de donaciones"),
                new UiCatalogItem_380_jh("DONATION_DETAIL", "Detalle de donacion"),
                new UiCatalogItem_380_jh("DONATION_DONOR", "Donante de donacion"),
                new UiCatalogItem_380_jh("DONATION_DATE", "Fecha de donacion"),
                new UiCatalogItem_380_jh("DONATION_QUANTITY", "Cantidad de unidades"),
                new UiCatalogItem_380_jh("DONATION_COMPONENT", "Componente de donacion"),
                new UiCatalogItem_380_jh("DONATION_EXPIRATION", "Vencimiento de donacion"),
                new UiCatalogItem_380_jh("DONATION_OBSERVATIONS", "Observaciones de donacion"),
                new UiCatalogItem_380_jh("DONATION_REGISTERED", "Donacion registrada"),
                new UiCatalogItem_380_jh("DONATION_INVALID", "Datos invalidos de donacion"),
                new UiCatalogItem_380_jh("DONATION_ERROR", "Error de donacion"),
                new UiCatalogItem_380_jh("UNITS_TITLE", "Titulo de unidades"),
                new UiCatalogItem_380_jh("UNITS_DESCRIPTION", "Descripcion de unidades"),
                new UiCatalogItem_380_jh("UNIT_DETAIL", "Detalle de unidad"),
                new UiCatalogItem_380_jh("UNIT_CODE", "Codigo de unidad"),
                new UiCatalogItem_380_jh("UNIT_DONOR", "Donante de unidad"),
                new UiCatalogItem_380_jh("UNIT_COMPONENT", "Componente de unidad"),
                new UiCatalogItem_380_jh("UNIT_EXPIRATION", "Vencimiento de unidad"),
                new UiCatalogItem_380_jh("UNIT_BLOOD_GROUP", "Grupo sanguineo"),
                new UiCatalogItem_380_jh("UNIT_RH", "Factor Rh"),
                new UiCatalogItem_380_jh("UNIT_STATUS", "Estado de unidad"),
                new UiCatalogItem_380_jh("UNIT_OBSERVATIONS", "Observaciones de unidad"),
                new UiCatalogItem_380_jh("UNIT_CLASSIFY", "Clasificar unidad"),
                new UiCatalogItem_380_jh("UNIT_RELEASE", "Liberar unidad"),
                new UiCatalogItem_380_jh("UNIT_BLOCK", "Bloquear unidad"),
                new UiCatalogItem_380_jh("UNIT_DISCARD", "Descartar unidad"),
                new UiCatalogItem_380_jh("UNIT_CLASSIFIED", "Unidad clasificada"),
                new UiCatalogItem_380_jh("UNIT_RELEASED", "Unidad liberada"),
                new UiCatalogItem_380_jh("UNIT_BLOCKED", "Unidad bloqueada"),
                new UiCatalogItem_380_jh("UNIT_DISCARDED", "Unidad descartada"),
                new UiCatalogItem_380_jh("UNIT_INVALID", "Datos invalidos de unidad"),
                new UiCatalogItem_380_jh("UNIT_CONFLICT", "Conflicto de estado de unidad"),
                new UiCatalogItem_380_jh("UNIT_ERROR", "Error de unidad"),
                new UiCatalogItem_380_jh("UNIT_STATE_EN_REVISION", "Estado en revision"),
                new UiCatalogItem_380_jh("UNIT_STATE_LIBERADA", "Estado liberada"),
                new UiCatalogItem_380_jh("UNIT_STATE_BLOQUEADA", "Estado bloqueada"),
                new UiCatalogItem_380_jh("UNIT_STATE_DESCARTADA", "Estado descartada"),
                new UiCatalogItem_380_jh("OPERATION_NOT_AUTHORIZED", "Operacion no autorizada")
            });
